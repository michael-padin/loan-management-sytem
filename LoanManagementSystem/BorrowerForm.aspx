<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BorrowerForm.aspx.cs" Inherits="CustomerForm" %>
        ...
        <div class="dashboard-wrapper">
            ...
            <div class="content-parent-wrapper">
                <div class="navbar-wrapper">
                    <uc:Navbar ID="Navbar1" runat="server" Title="Borrower Form" />
                </div>
                        ...
                        <div class="loan-application-wrapper">
                            ...
                            <div class="customer-information-wrapper">
                                ...
                                <div class="submit-btn-container">
                                    <asp:Button ID="btnSubmit" runat="server" Text="Add Borrower" OnClick="btnSubmit_Click" />
