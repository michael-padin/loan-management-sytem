        ...
        <div class="dashboard-wrapper">
            ...
            <div class="content-parent-wrapper">
                <div class="navbar-wrapper">
                    <uc:Navbar ID="Navbar1" runat="server" Title="Payments" />
                </div>
                        ...
                        <div class="customer-wrapper">
                            <div class="searchbar-wrapper">
                                ...
                                <!-- <div class="add-wrapper">
                                    <a href="/PaymentForm" class="add-link">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="customers-table" OnRowDeleting="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand" OnRowUpdating="GridView1_RowUpdating"> 
                                    <Columns>
                                        <asp:TemplateField HeaderText="Actions">
                                            <ItemTemplate>
                                                <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnEdit" CommandName="Update" CommandArgument='<%# Eval("PaymentId") %>'  />
                                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnDelete" CommandName="Delete" CommandArgument='<%# Eval("PaymentId") %>' />
