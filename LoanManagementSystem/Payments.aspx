                    ...
                    <div class="content-sub-wrapper">
                        <div class="customer-wrapper">
                            ...
                            <div class="customers-container">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="customers-table">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Actions">
                                            <ItemTemplate>
                                                <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btnAdd" />
                                                <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnEdit" />
